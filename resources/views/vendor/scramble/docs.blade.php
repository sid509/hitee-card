...
<head>
    ...
    <style>
        ...
        /* Custom Styles for Hitee API Docs */
        .sl-elements-api .sl-sidebar-header {
        ...
        .sl-elements-api .sl-sidebar-header img {
            max-height: 100px !important;
            width: auto !important;
            margin-right: 0 !important;
            margin-bottom: 1rem !important;
        }
        .sl-elements-api .sl-sidebar-header .sl-heading {
...
<script>
    (async () => {
        ...
        // Inject styles into shadow DOM if necessary
        const injectStyles = () => {
            if (docs.shadowRoot) {
                ...
                style.textContent = `
                    ...
                    .sl-sidebar-header img {
                        max-height: 80px !important;
                        width: auto !important;
                        margin-right: 0 !important;
                        margin-bottom: 1rem !important;
                    }
                    .sl-sidebar-header div:has(img) + div {
                        margin-left: 0 !important;
                        font-size: 1.1rem !important;
                        font-weight: 600 !important;
                    }
                    /* For title if it is a simple text sibling */
                    .sl-sidebar-header .sl-heading {
                        margin-left: 0 !important;
                        font-size: 1.1rem !important;
                    }
                `;
                docs.shadowRoot.appendChild(style);
            }
        };

        // Try injecting styles after a short delay to ensure shadowRoot is ready
